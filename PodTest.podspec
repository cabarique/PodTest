...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/cabarique/PodTest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'cabarique' => 'luis.cabarique@bizagi.com' }
  s.source           = { :git => 'https://github.com/cabarique/PodTest.git', :tag => s.version.to_s }
